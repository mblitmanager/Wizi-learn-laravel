...
@section('title', 'Modifier un domaine de formation')
@section('content')
                ...
                <div
                    ...
                    <div class="mb-3 mb-md-0">
                        <h5 class="card-title mb-1 text-primary">
                            <i class="bx bx-edit me-2"></i>Modification du domaine de formation
                        </h5>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('formations.show', $formation->id) }}" class="text-decoration-none">
                                        {{ $formation->titre }}
                                    </a>
                                </li>
                    ...
                    <div class="">
                        ...
                        <form action="{{ route('formations.duplicate', $formation->id) }}" method="POST"
                            class="d-inline ms-2">
                            @csrf
                            <button type="submit" class="btn btn-outline-warning"
                                onclick="return confirm('Dupliquer ce domaine ?')">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="titre" id="titre"
                                                    ...
                                                    placeholder="Entrez le titre du domaine" required>
                                                @error('titre')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="duree" id="duree"
                                                    ...
                                                    placeholder="Durée en heures" min="1" required>
                                                @error('duree')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="statut" id="statut"
                                                    ...
                                                    <option value="1"
                                                        {{ old('statut', $formation->statut) == '1' ? 'selected' : '' }}>
                                                        Actif</option>
                                                    <option value="0"
                                                        {{ old('statut', $formation->statut) == '0' ? 'selected' : '' }}>
                                                        Inactif</option>
                                                </select>
                                                @error('statut')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="description" rows="4"
                                                    class="form-control @error('description') is-invalid @enderror" placeholder="Décrivez le domaine de formation">{{ old('description', $formation->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
