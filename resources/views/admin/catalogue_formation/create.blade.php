...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Catalogue Formation</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="card-body">
        <h5 class="card-title text-wizi2">Ajouter catalogue de formations</h5>
        <hr>
        ...
        <div class="card">
            <form action="{{ route('catalogue_formation.store') }}" method="POST" class="px-4 py-4"
                ...
                <div class="card mb-4 px-4">
                    <div class="card-body">
                        <h5 class="text-wizi2">Créer une formation</h5>
