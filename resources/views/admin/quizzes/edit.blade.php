                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ route('quiz.index') }}"><i
                                        class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Modification d'un Quiz</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('quiz.update', $quiz->id) }}" method="POST"
                        ...
                        @method('PUT')
                        {{-- QUIZ --}}
                        <div class="card mb-4 px-2" id="quiz-form">
                            <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select name="questions[{{ $qIndex }}][type]"
                                                                ...
                                                                @foreach (['question audio', 'remplir le champ vide', 'carte flash', 'correspondance', 'choix multiples', 'rearrangement', 'vrai/faux', 'banque de mots'] as $type)
                                                                    <option
                                                                        value="{{ $type }}" {{ old("questions.$qIndex.type", $question->type) == $type ? 'selected' : '' }}>
                                                                        {{ ucfirst($type) }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <textarea name="questions[{{ $qIndex }}][explication]"
                                                                      class="form-control"
                                                                      rows="3">{{ old("questions.$qIndex.explication", $question->explication) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        <option
                                                                            value="1" {{ $reponse->is_correct ? 'selected' : '' }}>
                                                                            Oui
                                                                        </option>
                                                                        <option
                                                                            value="0" {{ !$reponse->is_correct ? 'selected' : '' }}>
                                                                            Non
                                                                        </option>
                                                                    </select>
                                                                </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-sm btn-primary px-5"><i class="lni lni-save"></i>Mettre
                                à
                                jour
                            </button>
                        </div>
    ...
    <script>
        document.querySelectorAll('.add-reponse-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                newReponse.classList.add('new-reponse');  // Ajout d'une classe CSS pour les nouvelles réponses
