                ...
                <div
                    ...
                    <div class="mb-3 mb-md-0">
                        <h5 class="card-title mb-1 text-primary">
                            <i class="bx bx-edit me-2"></i>Modification du partenaire
                        </h5>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('partenaires.show', $partenaire->id) }}" class="text-decoration-none">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('partenaires.update', $partenaire->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="identifiant" id="identifiant"
                                                    ...
                                                    value="{{ old('identifiant', $partenaire->identifiant) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="type" id="type"
                                                    ...
                                                    value="{{ old('type', $partenaire->type) }}"
                                                    placeholder="Type de partenaire" required>
                                                @error('type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                                ...
                                                @if ($partenaire->logo)
                                                    <div class="mb-3">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="{{ asset($partenaire->logo) }}" alt="Logo actuel"
                                                                class="rounded border"
                                                                style="max-width: 80px; max-height: 80px; object-fit: cover;">
                                                            <div>
                                                                <span class="badge bg-info text-dark">Logo actuel</span>
                                        ...
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="adresse" id="adresse"
                                                    ...
                                                    value="{{ old('adresse', $partenaire->adresse) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="ville" id="ville"
                                                    ...
                                                    value="{{ old('ville', $partenaire->ville) }}" placeholder="Ville"
                                                    required>
                                                @error('ville')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="code_postal" id="code_postal"
                                                    ...
                                                    value="{{ old('code_postal', $partenaire->code_postal) }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="departement" id="departement"
                                                    ...
                                                    value="{{ old('departement', $partenaire->departement) }}"
                                            ...
                                            <div class="card-header bg-white py-2">
                                                <h6 class="mb-0 fw-semibold text-dark">
                                                    ...
                                                    @if (!empty($c['nom']) || !empty($c['prenom']))
                                                        <span class="badge bg-primary ms-2">Renseigné</span>
                                                    @else
                                                        <span class="badge bg-secondary ms-2">Vide</span>
                                                    @endif
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="row g-3">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" name="contacts[{{ $i }}][nom]"
                                                            ...
                                                            value="{{ old("contacts.{$i}.nom", $c['nom'] ?? '') }}"
                                                            placeholder="Nom">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old("contacts.{$i}.prenom", $c['prenom'] ?? '') }}"
                                                            placeholder="Prénom">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old("contacts.{$i}.fonction", $c['fonction'] ?? '') }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="email" name="contacts[{{ $i }}][email]"
                                                            ...
                                                            value="{{ old("contacts.{$i}.email", $c['email'] ?? '') }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" name="contacts[{{ $i }}][tel]"
                                                            ...
                                                            value="{{ old("contacts.{$i}.tel", $c['tel'] ?? '') }}"
                                                            placeholder="+33 ...">
                            ...
                            <div class="card border-0 bg-light mb-4">
                                <div class="card-header bg-transparent border-bottom-0 py-3">
                                    <h6 class="mb-0 text-dark fw-semibold">
                                        ...
                                        <span
                                            class="badge bg-info text-dark ms-2">{{ $partenaire->stagiaires->count() }}</span>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <select name="stagiaires[]" id="stagiaires" multiple
                                                    ...
                                                    @foreach ($stagiaires as $stagiaire)
                                                        <option value="{{ $stagiaire->id }}"
                                                            {{ in_array($stagiaire->id, old('stagiaires', $partenaire->stagiaires->pluck('id')->toArray())) ? 'selected' : '' }}>
