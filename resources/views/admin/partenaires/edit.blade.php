                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active text-uppercase fw-bold" aria-current="page">Modifier d'un
                                partenaire</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <form action="{{ route('partenaires.update', $partenaire->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="identifiant" class="form-control"
                                    value="{{ $partenaire->identifiant }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="adresse" class="form-label">Adresse</label>
                                <input type="text" name="adresse" class="form-control" value="{{ $partenaire->adresse }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="ville" class="form-label">Ville</label>
                                <input type="text" name="ville" class="form-control" value="{{ $partenaire->ville }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="departement" class="form-label">Département</label>
                                <input type="text" name="departement" class="form-control"
                                    value="{{ $partenaire->departement }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="code_postal" class="form-label">Code postal</label>
                                <input type="text" name="code_postal" class="form-control"
                                    value="{{ $partenaire->code_postal }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="type" class="form-label">Type</label>
                                <input type="text" name="type" class="form-control" value="{{ $partenaire->type }}"
                                    required>
                            </div>
                            <div class="mb-3">
