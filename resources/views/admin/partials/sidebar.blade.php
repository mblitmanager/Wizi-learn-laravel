    ...
    <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('formateur.stagiaires.termines') }}"><i
                                class="bx bx-right-arrow-alt"></i>Formation terminée</a>
                    </li>
                </ul>
            </li>
        ...
        @if(auth()->user()->role === 'administrateur')
            <li>
                ...
                <ul>
                    <li> <a href="{{ route('parrainage.index') }}"><i class="bx bx-right-arrow-alt"></i>
                            Liste des parrains</a>
                    </li>
                    <li> <a href="{{ route('parrainage_events.index') }}"><i class="bx bx-right-arrow-alt"></i>
                            Événement parrainage</a>
                    </li>
                </ul>
            </li>
