                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text display-6" id="kpiOnlineNow">{{ $stats['online_users'] }}</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text display-6" id="kpiToday">{{ $stats['today_logins'] }}</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text display-6" id="kpiWeek">{{ $stats['week_logins'] }}</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text display-6" id="kpiMonth">{{ $stats['month_logins'] }}</p>
                            </div>
                        ...
                        <tbody>
                            @foreach ($stats['map_data'] as $index => $country)
                                <tr>
                                    ...
                                    <td>
                                        <strong class="cell-country">{{ $country['country'] }}</strong>
                                    </td>
                                    <td class="text-center">
                                        @if ($country['code'])
                                            <span class="fi cell-flag fi-{{ strtolower($country['code']) }}"></span>
                                        @else
                                    ...
                                    <td class="cell-value">
                                        <div class="progress" style="height: 25px;">
                                            <div class="progress-bar bg-info" role="progressbar"
                                                ...
                                                <span class="cell-value-text">{{ $country['value'] }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="cell-last-activity" data-ts="{{ $country['last_activity'] }}">
                                        {{ \Carbon\Carbon::parse($country['last_activity'])->diffForHumans() }}
                                        <small class="text-muted d-block">
                                            <span
                                                class="cell-last-activity-date">{{ \Carbon\Carbon::parse($country['last_activity'])->format('d/m/Y H:i') }}</span>
                                        </small>
                                    </td>
                                </tr>
                            @endforeach
        ...
        $(document).ready(function() {
            ...
            function refreshActivity() {
                $.get('{{ route('dashboard.activity.data') }}', function(resp) {
                    ...
                    // KPIs
                    $('#kpiOnlineNow').text(stats.online_users);
                    $('#kpiToday').text(stats.today_logins);
                    $('#kpiWeek').text(stats.week_logins);
                    $('#kpiMonth').text(stats.month_logins);
                    ...
                    (stats.map_data || []).forEach((country, idx) => {
                        ...
                        <tr>
                          ...
                          <td><strong class="cell-country">${country.country}</strong></td>
                          <td class="text-center">${code ? `<span class="fi fi-${code}"></span>` : '<i class="fas fa-globe"></i>'}</td>
                          <td class="cell-value">
                            <div class="progress" style="height: 25px;">
                          ...
                          <td class="cell-percent">${percent}%</td>
                          <td class="cell-last-activity" data-ts="${last}">
                            ${moment(last).fromNow()}<small class="text-muted d-block"><span class="cell-last-activity-date">${moment(last).format('DD/MM/YYYY HH:mm')}</span></small>
                          </td>
                        </tr>`;
                        tbody.append(row);
                    });
