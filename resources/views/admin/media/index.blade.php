        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-bottom-0 py-3">
                <h6 class="mb-0 text-dark fw-semibold">
                    ...
                    <span class="badge bg-info text-dark ms-2">{{ $media->count() }}</span>
                </h6>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($media as $row)
                                <tr>
                                    <td class="text-center">
                                        @if ($row->type === 'image')
                                            <img src="{{ asset($row->url) }}" alt="Image" class="media-preview">
                                    ...
                                    <td>
                                        <span class="badge bg-light text-dark">{{ $row->categorie }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="badge 
...
@section('scripts')
    <script>
        $(document).ready(function() {
            var hasData = {{ $media->count() > 0 ? 'true' : 'false' }};
