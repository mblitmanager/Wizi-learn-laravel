               ...
               <div class="ps-3">
                   <nav aria-label="breadcrumb">
                       <ol class="breadcrumb mb-0 p-0">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">Création d'un medias</li>
                       </ol>
                   </nav>
               </div>
               <div class="ms-auto">
               ...
               <div class="container py-4">
                   <div class="card">
                       <div class="card-body p-4">
                           <form class="row g-4" action="{{ route('medias.store') }}" method="POST" enctype="multipart/form-data">
                               @csrf
                               ...
                               <div class="row">
                                   <div class="mb-3">
                                       ...
                                       <textarea name="description" id="description"
                                                 class="form-control @error('description') is-invalid @enderror" rows="8">{{ old('description', $medias->description ?? '') }}</textarea>
                                       @error('description')
                                       <div class="invalid-feedback">{{ $message }}</div>
                                       @enderror
                                   </div>
