                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Détails d'un pôle relation client</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                        ...
                        <div class="main-body">
                            <div class="row">
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    <span
                                        class="badge bg-info text-dark px-3 py-1">{{ ucfirst($poleRelationClient->user->role) }}</span>
                                </div>
