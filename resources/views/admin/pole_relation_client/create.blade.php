...
@section('title', 'Créer un pôle relation client')
@section('content')
                ...
                <div
                    ...
                    <div class="mb-3 mb-md-0">
                        <h5 class="card-title mb-1 text-primary">
                            <i class="bx bx-user-plus me-2"></i>Création d'un pôle relation client
                        </h5>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active text-dark fw-semibold" aria-current="page">
                                    Nouveau pôle relation client
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="btn-group">
                        <a href="{{ route('pole_relation_clients.index') }}" class="btn btn-outline-primary">
                        ...
                        <form class="row g-3" action="{{ route('pole_relation_clients.store') }}" method="POST"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="role" id="role"
                                                    ...
                                                    value="{{ old('role') }}" placeholder="Ex: conseiller, consultant..."
                                                    list="role-options" required>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary px-5 py-2 me-3">
                                    <i class="bx bx-save me-2"></i> Créer le pôle relation client
                                </button>
