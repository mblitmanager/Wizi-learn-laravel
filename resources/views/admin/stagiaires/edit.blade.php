                ...
                <div
                    ...
                    <div class="mb-3 mb-md-0">
                        <h5 class="card-title mb-1 text-primary">
                            <i class="bx bx-edit me-2"></i>Modification d'un stagiaire
                        </h5>
                    ...
                    <div class="btn-group">
                        ...
                        <a href="{{ route('stagiaires.index') }}" class="btn btn-outline-primary ms-2">
        ...
        @if ($errors->any())
            <div class="alert alert-danger border-0 alert-dismissible fade show shadow-sm mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <strong class="fw-semibold">Veuillez corriger les erreurs suivantes :</strong>
                        ...
                        <form class="row g-3" action="{{ route('stagiaires.update', $stagiaire->id) }}" method="POST">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="ville" id="ville"
                                                    ...
                                                    value="{{ old('ville', $stagiaire->ville) }}" placeholder="Ville">
                                                @error('ville')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="headingFormations">
                                                <button class="accordion-button bg-primary text-white" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseFormations"
                                            ...
                                            <div id="collapseFormations" class="accordion-collapse collapse show"
                                                ...
                                                <select name="partenaire_id"
                                                    ...
                                                    @foreach ($partenaires as $partenaire)
                                                        <option value="{{ $partenaire->id }}"
                                                            {{ old('partenaire_id', $stagiaire->partenaire_id) == $partenaire->id ? 'selected' : '' }}>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-success px-5 py-2">
                                    <i class="bx bx-save me-2"></i> Mettre à jour le stagiaire
                                </button>
                            </div>
                        </form>
                    </div>
