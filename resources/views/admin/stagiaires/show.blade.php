                            ...
                            <div class="row">
                                <div class="card-body">
                                    ...
                                    <div class="container my-4">
                                                            ...
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="formateur-collapse-{{ $index }}"
                                                                    ...
                                                                    <div class="accordion-body">
                                                                        ...
                                                                        <ul class="list-group">
                                                                            @if (is_iterable($formateur->catalogue_formations))
                                        ...
                                        @php
                                            $poleRelationClients = $stagiaire->poleRelationClient ?? collect();
                                        @endphp
                                        @unless ($poleRelationClients->isEmpty())
                                            <div class="card mb-4 shadow-sm">
                                                <div class="card-header text-dark">
                                                    <h5 class="mb-0"><i class="bx bx-briefcase-alt-2 me-2"></i> Pôle
                                                        Relation Client
                                                        Associés</h5>
                                                </div>
                                                <div class="card-body"
                                                    style="box-shadow: rgba(17, 12, 46, 0.15) 0px 48px 100px 0px;">
                                                    <div class="accordion accordion-flush" id="accordionPoleRelation">
                                                        @foreach ($poleRelationClients as $index => $poleRelation)
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header"
                                                                    id="poleRelation-heading-{{ $index }}">
                                                                    <button
                                                                        class="accordion-button d-flex justify-content-between align-items-center shadow-sm p-3 collapsed"
                                                                        type="button" data-bs-toggle="collapse"
                                                                        data-bs-target="#poleRelation-collapse-{{ $index }}"
                                                                        aria-expanded="false"
                                                                        aria-controls="poleRelation-collapse-{{ $index }}">
                                                                        <div class="d-flex align-items-center">
                                                                            <i class="bx bx-user-circle me-3"
                                                                                style="font-size: 1.5rem;"></i>
                                                                            <div class="">
                                                                                {{ $poleRelation->user->name }}
                                                                            </div>
                                                                        </div>
                                                                    </button>
                                                                </h2>
                                                                <div id="poleRelation-collapse-{{ $index }}"
                                                                    class="accordion-collapse collapse"
                                                                    aria-labelledby="poleRelation-heading-{{ $index }}"
                                                                    data-bs-parent="#accordionPoleRelation">
                                                                    <div class="accordion-body">
                                                                        <ul class="list-group list-group-flush">
                                                                            <li class="list-group-item"><strong>Nom :</strong>
                                                                                {{ $poleRelation->prenom }}
                                                                            ...
                                                                            <li class="list-group-item"><strong>Date de
                                                                                    création :</strong>
                                                                                {{ $poleRelation->created_at->format('d/m/Y à H:i') }}
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
