...
@section('content')
    <div class="container py-3">
        ...
        <div class="mb-3">
            <a href="{{ route('admin.stagiaires.stats.export', request()->all()) }}" class="btn btn-success btn-sm">Exporter
                CSV</a>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="h4 mb-0">{{ $inactive3 }}</div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="h4 mb-0">{{ $inactive7 }}</div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="h4 mb-0">{{ $inactive30 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table align-middle mb-0">
                ...
                <tbody>
                    @forelse($stagiaires as $s)
                        <tr>
                            <td>
                                <a href="{{ route('stagiaires.show', $s->stagiaire_id) }}">{{ $s->name }}</a>
                            </td>
                            <td>{{ $s->email }}</td>
