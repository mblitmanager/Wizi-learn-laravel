                ...
                <div
                    ...
                    <div class="mb-3 mb-md-0">
                        <h5 class="card-title mb-1 text-primary">
                            <i class="bx bx-edit me-2"></i>Modification du commercial
                        </h5>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('commercials.show', $commercial->id) }}" class="text-decoration-none">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select name="civilite" id="civilite"
                                                    ...
                                                    <option value="M."
                                                        {{ old('civilite', $commercial->civilite ?? '') == 'M.' ? 'selected' : '' }}>
                                                        M.</option>
                                                    <option value="Mme."
                                                        {{ old('civilite', $commercial->civilite ?? '') == 'Mme.' ? 'selected' : '' }}>
                                                        Mme.</option>
                                                    <option value="Mlle."
                                            ...
                                            @if ($commercial->user->image)
                                                <div class="mb-3">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="{{ asset($commercial->user->image) }}"
                            ...
                            <div class="card border-0 bg-light mb-4">
                                <div class="card-header bg-transparent border-bottom-0 py-3">
                                    <h6 class="mb-0 text-dark fw-semibold">
                                        ...
                                        <span
                                            class="badge bg-info text-dark ms-2">{{ $commercial->stagiaires->count() }}</span>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
