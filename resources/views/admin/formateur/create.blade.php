                ...
                <div
                    ...
                    <div class="mb-3 mb-md-0">
                        <h5 class="card-title mb-1 text-primary">
                            <i class="bx bx-user-plus me-2"></i>Création d'un formateur
                        </h5>
                    ...
                    <div class="btn-group">
                        <a href="{{ route('formateur.index') }}" class="btn btn-outline-primary">
                        ...
                        <form class="row g-3" action="{{ route('formateur.store') }}" method="POST"
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary px-5 py-2 me-3">
                                    <i class="bx bx-save me-2"></i> Créer le formateur
                                </button>
