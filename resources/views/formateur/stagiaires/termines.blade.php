...
<div class="container-fluid">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active text-uppercase fw-bold" aria-current="page">Stagiaires Récemment Terminés
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    @endforeach
                                    ...
                                    <td>{{ $stagiaire->date_fin_formation ? \Carbon\Carbon::parse($stagiaire->date_fin_formation)->format('d/m/Y') : 'Non définie' }}</td>
                                    <td>
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        {{ $stagiairesTermines->links() }}
                    </div>
                    @else
                    <div class="alert alert-info text-center">
                        <h5>Aucun stagiaire récemment terminé</h5>
                        <p>Aucun de vos stagiaires n'a terminé sa formation dans les 12 derniers mois.</p>
                    </div>
                    @endif
                </div>
            </div>
