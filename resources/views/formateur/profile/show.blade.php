                                    ...
                                    <div class="profile-image-wrapper mb-3">
                                        <div class="avatar-upload">
                                            ...
                                            <div class="avatar-preview">
                                                <div id="imagePreview"
                                                    style="background-image: url('{{ $user->image ? asset('storage/' . $user->image) : asset('assets/images/default-avatar.png') }}');">
                                                </div>
                                            </div>
                                        </div>
                                        <small class="text-muted d-block mt-2">Cliquez sur l'appareil photo pour changer
                                            votre photo</small>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-3">
                            <i class="fas fa-user-tag mr-1"></i>{{ ucfirst($formateur->role) }}
                        </p>
                    ...
                    <div class="card-body">
                        <div class="account-info">
                            ...
                            <div class="info-item d-flex justify-content-between mb-2">
                                ...
                                <span
                                    class="font-weight-bold">{{ \Carbon\Carbon::parse($user->last_login_at) ? \Carbon\Carbon::parse($user->last_login_at)->format('d/m/Y H:i') : 'N/A' }}</span>
                            </div>
